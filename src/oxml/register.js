...
let {CT_Num, CT_NumLvl, CT_NumPr, CT_Numbering} = require('./numbering');
...
let {CT_Height, CT_Row, CT_Tbl, CT_TblGrid, CT_TblGridCol, CT_TblLayoutType,
    CT_TblPr, CT_TblWidth, CT_Tc, CT_TcPr, CT_TrPr, CT_VMerge, CT_VerticalJc, CT_Bidi} = require('./table');
...
let {CT_Ind, CT_Jc, CT_PPr, CT_Spacing, CT_TabStop, CT_TabStops} = require('./text/parfmt');
